...
const state = {
  ...
  */
  ...
  const deleteTask = (e) => {
    ...
    const newTaskList = state.taskList.filter(({ id }) => id !== targetId);
...
const handleNavigation = (page) => {
    switch (page) {
      case 'home':
        // Perform actions for the home page
        alert('Navigating to Home page');
        // Example: Redirect to the home page
        window.location.href = 'index.html';
        break;
      case 'about':
        // Perform actions for the about page
        alert('Navigating to About page');
        // Example: Redirect to the about page
        window.location.href = 'about.html';
        break;
      case 'contact':
        // Perform actions for the contact page
        alert('Navigating to Contact page');
        // Example: Redirect to the contact page
